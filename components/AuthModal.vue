  ...
  <div class="modal-overlay" @click.self="$emit('close')">
    <div class="modal-content">
      ...
      <div class="auth-form">
        ...
        <button @click="handleGoogleAuth" :disabled="loading" class="oauth-button google-button">
        ...
        <button @click="handleGithubAuth" :disabled="loading" class="oauth-button github-button">
